...
int main(int argc, char **argv) {
    std::cout << "1 time: " << getCurrentTime() << std::endl;
    ...
    std::cout << "4 time: " << getCurrentTime() << std::endl;

    for (int f = 0; f < (int) params.fname_inp.size(); ++f) {
        std::cout << f << " of 5 time: " << getCurrentTime() << std::endl;
    ...
    std::cout << "6 time: " << getCurrentTime() << std::endl;
    sense_voice_free(ctx);
    std::cout << "7 time: " << getCurrentTime() << std::endl;
    return 0;
}
